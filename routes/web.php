...
// Authenticated routes — redirect based on role after login
...
Route::middleware(['auth', 'instructor'])
    ...
    ->group(function () {
        ...
        Route::resource('courses.enrolments', Instructor\EnrolmentController::class)
            ->shallow();
    });
...
Route::middleware(['auth', 'student'])
    ...
    ->group(function () {
        ...
        Route::post('/courses/{course}/enrol', [Student\CourseController::class, 'enrol'])
            ->name('courses.enrol');
